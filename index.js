...
app.listen(PORT, err => {
  if(err) console.log(err)
		...
		console.log(`http://localhost:3000/api/songs?title=Best`)
		console.log(`http://localhost:3000/api/songs?composer=Holland`)
		console.log(`http://localhost:3000/api/songs?title=Girl&composer=Jobim`)
